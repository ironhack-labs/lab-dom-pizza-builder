...
document.querySelectorAll('.mushroom').forEach(oneMush => {
  if (state.mushrooms) {
     oneMush.style.visibility = 'visible'} else {
...
let price = basePrice;
let composition=document.querySelector('aside.panel.price ul');
composition.innerHTML="";

for (let i in ingredients) { if (state[i]) {
 price += ingredients[i].price;
 composition.innerHTML +=`<li>$${ingredients[i].price} ${ingredients[i].name}</li>`
    }
  }
