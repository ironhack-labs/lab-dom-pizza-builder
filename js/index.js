...
function renderMushrooms() {
  ...
  document.querySelectorAll('.mushroom');.forEach(oneMushy => {
    if (state.mushrooms) {
      oneMushy.style.visibility = 'visible';
    } else {
      oneMushy.style.visibility = 'hidden';
    }
  });
}
...
function renderPrice() {
  ...
  let whiteText= document.createElement('li').innerText= '$3 white sauce'
  
  let freeText= document.createElement('li').innerText= '$5 gluten-free crust'
