...
function renderWhiteSauce() {
  ...
  const oneSW = document.querySelector('.sauce');
      if (!state.whiteSauce) {
        oneSW.classList.remove('sauce-white');
      } else {
        oneSW.classList.add('sauce-white');
      }
}

function renderGlutenFreeCrust() {
  // Iteration 2: add/remove the class "crust-gluten-free" of `<section class="crust">`
  const oneCru = document.querySelector('.crust');
      if (!state.glutenFreeCrust) {
        oneCru.classList.remove('crust-gluten-free');
      } else {
        oneCru.classList.add('crust-gluten-free');
      }
}
