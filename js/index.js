...
function renderGlutenFreeCrust() {
  ...
  let sectionCrust = document.querySelector('.crust');
...
function renderPrice() {
  ...
  var dollarUl = document.querySelector('aside.panel.price ul');
  dollarUl.innerHTML = ""

  for (var ingredient in ingredients) {
    if (state[ingredient]) {
      finalPrice += ingredients[ingredient].price
      dollarUl.innerHTML += `<li>$${ingredients[ingredient].price} ${ingredients[ingredient].name.toLowerCase()}</li>`;
    } 
  }
