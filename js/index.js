...
function renderWhiteSauce() {
  ...
  document.querySelectorAll('.sauce').forEach((oneSauce) => {
    oneSauce.classList.toggle('sauce-white', state.whiteSauce);
  })
}
...
function renderGlutenFreeCrust() {
  ...
  document.querySelectorAll('.crust').forEach((oneCrust) => {
    oneCrust.classList.toggle('crust-gluten-free', state.glutenFreeCrust);
  })
}
...
function renderButtons() {
  ...
  document.querySelectorAll('.btn').forEach((oneBtn) => {
    oneBtn.classList.toggle('active', state[oneBtn.dataset.option]);
  })
}
