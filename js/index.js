...
function renderButtons() {
  ...
  document.querySelectorAll('.btn-mushrooms').forEach(oneMush => {
    if(state.mushrooms){
      oneMush.classList.add('active');
    } else {
      oneMush.classList.remove('active');
    }
  });

  document.querySelectorAll('.btn-green-peppers').forEach(oneGreenPepper => {
    if(state.greenPeppers){
      oneGreenPepper.classList.add('active');
    } else {
      oneGreenPepper.classList.remove('active');
    }
  });
  
  document.querySelectorAll('.btn-sauce').forEach(oneWhiteSauce => {
    if(state.whiteSauce){
      oneWhiteSauce.classList.add('active');
    } else {
      oneWhiteSauce.classList.remove('active');
    }
  });

  document.querySelectorAll('.btn-crust').forEach(oneCrust => {
    if(state.glutenFreeCrust){
      oneCrust.classList.add('active');
    } else {
      oneCrust.classList.remove('active');
    }
  });
...
for (let key of Object.keys(state)){
  console.log(key)
   if(state[key]){
    ...
    document.getElementById(key).style.display="inherit"
