...
function renderWhiteSauce() {
  ...
  let sauceClasses = document.querySelectorAll(".sauce");

  sauceClasses.forEach((sauce) => {
    if (state.whiteSauce) {
...
function renderGlutenFreeCrust() {
  ...
  let crustClasses = document.querySelectorAll(".crust");

  crustClasses.forEach((crust) => {
...
function renderPrice() {
  ...
  let $panelUl = document.querySelector("aside ul");
