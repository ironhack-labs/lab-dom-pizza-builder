...
function renderMushrooms() {
  ...
  document.querySelectorAll(".mushroom").forEach((mushPice) => {
    mushPice.style.visibility = state.mushrooms ? "visible" : "hidden";
  })
}
...
function renderGreenPeppers() {
  ...
  document.querySelectorAll(".green-pepper").forEach(onePeper => {
    onePeper.style.visibility = state.greenPeppers ? "visible" : "hidden"
    // if (state.pepperoni) {
