...
function renderMushrooms() {
  ...
  document.querySelectorAll('.mushroom').forEach(mushroom => {
    if (state.mushrooms) {
      mushroom.setAttribute('style', 'visibility: visible')
    } else {
      mushroom.setAttribute('style', 'visibility: hidden')
    }
  })
}
...
function renderGreenPeppers() {
  ...
  document.querySelectorAll('.green-pepper').forEach(pepper => {
    if (state.greenPeppers) {
      pepper.setAttribute('style', 'visibility: visible')
    } else {
      pepper.setAttribute('style', 'visibility: hidden')
    }
  })
}
