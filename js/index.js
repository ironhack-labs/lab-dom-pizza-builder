...
function renderPrice() {
  ...
  let total = basePrice;
  document.querySelectorAll('.price > ul :nth-child(1)').forEach(list => {
    if (state.pepperoni) {
  ...
  document.querySelectorAll('.price > ul :nth-child(2)').forEach(list => {
    if (state.mushrooms) {
      list.style.visibility = 'visible';
  ...
  document.querySelectorAll('.price > ul :nth-child(3)').forEach(list => {
    if (state.greenPeppers) {
      list.style.visibility = 'visible';
  ...
  document.querySelectorAll('.price > ul :nth-child(4)').forEach(list => {
    if (state.whiteSauce) {
      list.style.visibility = 'visible';
  ...
  document.querySelectorAll('.price > ul :nth-child(5)').forEach(list => {
    if (state.glutenFreeCrust) {
      list.style.visibility = 'visible';
