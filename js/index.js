...
function renderGreenPeppers() {
  ...
  document.querySelectorAll('.green-pepper').forEach(oneMush => {
...
function renderWhiteSauce() {
  ...
  document.querySelectorAll('.sauce').forEach(oneMush => {
    if (state.whiteSauce) {
      oneMush.classList.add('sauce-white');
    } else {
      oneMush.classList.remove('sauce-white');
    }
  });
  }
...
function renderGlutenFreeCrust() {
  ...
  document.querySelectorAll('.crust').forEach(oneMush => {
...
function renderPrice() {
  // Iteration 4: change the HTML of `<aside class="panel price">`	  const list = document.querySelector(".price ul");
