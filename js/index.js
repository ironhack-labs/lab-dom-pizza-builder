...
const classFor = {
  ...
  mushoroms: 'btn-mushrooms',
  greenPeppers: 'btn-green-peppers',
  whiteSauce: 'btn-sauce',
  glutenFreeCrust: '.btn-crust'
};

if (state.ingredientx) {
  document.querySelector('.btn-classX').classList.add('active');
} else {
  document.querySelector('.btn-classX').classList.remove('active');
}
...
function renderPrice() {
  ...
  //   if (state.pepperoni) {
  //     document.querySelector('.panel price>li:nth-child(1)
  //     );
