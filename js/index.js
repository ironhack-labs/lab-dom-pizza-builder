...
function renderButtons() {
  ...
  //   
    if (state.pepperoni) {
      document.querySelector('.btn-peperoni').classList.add('active');
    } else {document.querySelector('.btn-peperoni').classList.remove('active')}
  
    if (state.mushrooms) {
      document.querySelector('.btn-mushroom').classList.add('active');
    } else {document.querySelector('.btn-mushroom').classList.remove('active')}
  
    if (state.greenPeppers) {
      document.querySelector('.btn-green-pepper').classList.add('active');
    } else {document.querySelector('.btn-green-pepper').classList.remove('active')}
...
function renderPrice() {
  ...
  // feel like my brain stopped working have no idea how to approach for this iteration, my test also stopped running I cant find why
}
