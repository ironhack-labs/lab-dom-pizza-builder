...
console.log(sauceTest);

sauceTest.forEach(whiteSauces => {
...
function renderGlutenFreeCrust() {
  ...
  console.log(crustTest);
  
  crustTest.forEach(crustyCrust => {
    if (state.glutenFreeCrust === false) {
      crustyCrust.classList.add("crust-gluten-free")
    } else {
      crustyCrust.classList.remove("crust-gluten-free")
    }
  })
...
function renderPrice() {
  ...
  //idea:
  //if (state.pepperoni) {
  //const extraPep = document.getElementsByClassName("panel-price" li[0]).style.display = 'block'
  //} 
