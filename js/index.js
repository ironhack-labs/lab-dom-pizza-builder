...
let buttons = {
  pepperoni: { button: '.btn.btn-pepperoni'},
  mushrooms: { button: 'btn.btn-mushrooms'},
  greenPeppers: { button: '.btn.btn-green-peppers'},
  whiteSauce: { button: '.btn.btn-sauce'},
  glutenFreeCrust: { button: '.btn.btn-crust'}
}
8
