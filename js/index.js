...
function renderButtons() {
  ...
  let btnPeppers = document.querySelector('.btn.btn-green-peppers');
...
function renderPrice() {
  ...
  let priceDisplay = document.querySelector('.panel.price strong');
  list.innerHTML = '';
  for (var i in ingredients) {
    if (state[i]) {
      totalPrice += ingredients[i].price;
      list.innerHTML += `<li>$${ingredients[i].price} ${ingredients[
        i
      ].name.toLowerCase()}</li>`;
    }
