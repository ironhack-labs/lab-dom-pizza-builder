...
function renderButtons() {
  ...
  document.querySelectorAll('.btn-green-peppers').forEach(oneGreenPep => {
    if(state.greenPeppers){
      oneGreenPep.classList.add('active');
    } else {
      oneGreenPep.classList.remove('active');
    }
  });

  document.querySelectorAll('.btn-sauce').forEach(oneSauce => {
    if(state.whiteSauce){
     oneSauce.classList.add('active');
    } else {
      oneSauce.classList.remove('active');
    }
  });
