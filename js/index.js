...
function renderGlutenFreeCrust() {
    document.querySelectorAll('.crust').forEach(gCrust => {
        if (state.glutenFreeCrust) {
            gCrust.classList.add("crust-gluten-free")
        } else {
            gCrust.classList.remove("crust-gluten-free");
        }
    });
}
...
function renderPrice() {
    const getPanelPrice = document.getElementsByClassName('panel price')
