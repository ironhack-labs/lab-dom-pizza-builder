...
function renderWhiteSauce() {
  ...
  const whiteSauce = document.querySelectorAll('.sauce')

  whiteSauce.forEach((suace) => {
    if (state.whiteSauce) {
      suace.style.visibility = 'visible'
    } else {
      suace.style.visibility = 'hidden'
    }
  })
}
