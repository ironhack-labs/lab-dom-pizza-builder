...
function renderGreenPeppers() {
  document.querySelectorAll('.greenPepper').forEach(oneGreen => {
...
function renderGlutenFreeCrust() {
  let crustTipo = document.querySelector(".crust");
  if (state.glutenFreeCrust) {
    crustTipo.classList.add("crust-gluten-free");
  } else {
    crustTipo.classList.remove("crust-gluten-free");
  }
}
