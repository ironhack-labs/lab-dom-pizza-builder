...
function renderButtons() {
  ...
  state.mushrooms ? buttons[0].classList.add('active') : buttons[0].classList.remove('active');

  document.querySelectorAll('.btn')
  state.greenPeppers ? buttons[0].classList.add('active') : buttons[0].classList.remove('active');

  document.querySelectorAll('.btn')
  state.whiteSauce ? buttons[0].classList.add('active') : buttons[0].classList.remove('active');
