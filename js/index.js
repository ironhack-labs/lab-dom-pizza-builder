...
function renderGlutenFreeCrust() {
  ...
  const glutenC = document.querySelector('.crust');
  if (state.glutenFreeCrust) {
    glutenC.classList.add('crust-gluten-free');
  } else {
    glutenC.classList.remove('crust-gluten-free');
  }
}
...
function renderButtons() {
  ...
  for (button of buttons) {
    ...
    const ingredient = Object.keys(ingredients).find(
      (key) => ingredients[key].name === text
    );
...
function renderPrice() {
  const totalPrice = document.querySelector('.panel strong');
