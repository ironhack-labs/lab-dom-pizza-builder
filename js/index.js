...
function renderButtons() {
  ...
  let countBtn = document.querySelectorAll('btn');
  countBtn.forEach(function(singlebtn){
    singlebtn.onclick = singlebtn.classList.toggle('active');
  });
}

function renderPrice() {
  // Iteration 4: change the HTML of `<aside class="panel price">`
  // let liClass = document.querySelector('.panel.price ul').children;
  // if (pepperoni.state){
  //   liClass[0].style.display = 'block';;
  // }else{
  //   liClass[0].style.display = 'none';
  // }
}
