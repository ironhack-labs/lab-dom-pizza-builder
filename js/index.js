...
function renderPrice() {
  ...
  let pricesTotal = basePrice;
  let listOfIngredients = '';

  for (let key in state) {
    if (state[key]) {
      listOfIngredients += `<li>$ ${ingredients[key].price} ${ingredients[key].name}</li>`;
      pricesTotal += ingredients[key].price;
    }
  }

  document.querySelector('.price ul').innerHTML = listOfIngredients;
  document.querySelector('.price strong').innerHTML = pricesTotal;
