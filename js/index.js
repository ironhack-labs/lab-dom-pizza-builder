...
function renderPrice() {
  ...
  for (let i = 0; i < Object.keys(state).length; i++) {
    if (Object.values(state)[i]) {
      priceList.innerHTML += `<li>${Object.values(Object.values(ingredients)[i])[1]} ${Object.values(Object.values(ingredients)[i])[0]}</li>`
      total += Object.values(Object.values(ingredients)[i])[1];
    }
  }
