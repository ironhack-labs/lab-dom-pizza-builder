...
//con el objeto DOCUMENT = document  podermos acceder al formulario  seguido de un . podemos ingresar a esa seccion
//document.header(0).action  <= o donde se coloca el action es una propidad que tiene el form, un div text


//.elements son los elementos que contiene una seccion por ejemeplo una lista ul li1 li2 li3
//
