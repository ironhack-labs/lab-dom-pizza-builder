...
function renderButtons() {
  ...
  if(state.pepperonni){
    ...
    document.querySelector('.btn.btn-pepperonni').classList.remove('acitve');
  }
...
function renderPrice() {
  ...
  let total = 10;
  let lista = document.querySelector('.panel.price ul');
  lista.innerHTML = '';
  if(state.pepperonni){
    lista.innerHTML = '<li>$1 pepperonni</li>';
    total += 1;
  }
  if(state.mushrooms){
    lista.innerHTML = '<li>$1 mushrooms</li>';
    total += 1;
  }
  if(state.greenPeppers){
    lista.innerHTML = '<li>$1 green peppers</li>';
    total += 1;
  }
  if(state.whiteSauce){
    lista.innerHTML = '<li>$3 white sauce</li>';
    total += 3;
  }
  if(state.glutenFreeCrust){
    lista.innerHTML = '<li>$5 gluten free crust</li>';
    total += 5;
  }
