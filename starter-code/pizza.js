...
function renderPrice() {
  ...
  const obj = Object.keys(ingredients)
  let sum = 10;
  obj.forEach((ingredient, index) => {

    if (state[ingredient] === false) {
      document.querySelectorAll(".panel.price ul li")[index].style.display = "none";
    } else {
      document.querySelectorAll(".panel.price ul li")[index].style.display = "block";
