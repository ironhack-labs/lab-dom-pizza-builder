...
function renderButtons() {
  ...
  const but = document.querySelector(".controls");
...
function renderPrice() {
  ...
  const priceTotal = document.querySelector(".price strong");
  ...
  Object.keys(state).forEach(ingredient => {
    if (state[ingredient]) {
      newTotal = newTotal + ingredients[ingredient].price; 
