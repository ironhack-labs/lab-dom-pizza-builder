...
function renderWhiteSauce() {
  ...
  if (state.whiteSauce) {
    ...
    //document.getElementById('.sauce').classList.add('.sauce-white');
  }
  else {
    document.querySelector('.sauce').classList.remove('sauce-white')
    //document.getElementById('.sauce').classList.remove('.sauce-white');
  }
}
...
*/
  ...
  if(state.whiteSauce){
    document.getElementById('whi').style.display = 'block';
    suma += ingredients.whiteSauce.price
  } else{
    document.getElementById('whi').style.display = 'none';
  }
  if(state.glutenFreeCrust){
    document.getElementById('glu').style.display = 'block';
