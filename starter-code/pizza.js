...
function renderPrice() {
  ...
  let output = "";
  if (state.pepperonni) {
    output += "<li>$1 pepperonni</li>";
    totalPrice += ingredients.pepperonni.price;
  }
  if (state.mushrooms) {
    output += "<li>$1 mushrooms</li>";
    totalPrice += ingredients.mushrooms.price;
  }
  if (state.greenPeppers) {
    output += "<li>$1 green peppers</li>";
    totalPrice += ingredients.greenPeppers.price;
  }
  if (state.whiteSauce) {
    output += "<li>$3 white sauce</li>";
    totalPrice += ingredients.whiteSauce.price;
  }
  if (state.glutenFreeCrust) {
    output += "<li>$5 gluten-free crust</li>";
    totalPrice += ingredients.glutenFreeCrust.price;
  }

  document.querySelector("aside > ul").innerHTML = output;
